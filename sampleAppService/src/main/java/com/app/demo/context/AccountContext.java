...
public class AccountContext {
    ...
    /**
     * Bind the passed username to the account Context thread. This username is not set on the {@link Person}.
     */
    ...
    /**
     * Return the {@link Person} instance bound to the current thread, if any.
     *
    ...
    /**
     * Tell whether the passed account is the same as the {@link Person}
     * instance bound to the current thread, that is if their ids are equals.
     * It can be used for security purposes.
     *
     * @return true if the {@link Person} primary keys are equal, false otherwise.
     */
    public boolean isAccount(Person accountToCheck) {
        if (account != null && account.isIdSet() && accountToCheck != null) {
