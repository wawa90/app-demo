...
import com.app.demo.context.AccountContext;
 ...
 * <ul>
 * <li>security filtering, if you specify a filter such as <code>id = (:currentAccountId)</code></li>
...
public class HibernateFilterContext {
    ...
    private String getCurrentAccountId() {
        ...
        Person account = AccountContext.getAccountContext().getAccount();
        if (account != null) {
